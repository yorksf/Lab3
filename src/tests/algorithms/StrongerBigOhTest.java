 ...
 * @version 2013-08-13
 */
public class StrongerBigOhTest
{
    ...
    public void testRunAlgorithmInvalidChoice()
    {
        ...
        assertTrue(ans < 0,
            "runAlgorithm runs unexpected algorithm for choice = -1");
    }
    ...
    public void testEstimateTiming()
    {
        ...
        assertEquals(CORRECT, student, TOL, "estimateTiming equation is incorrect.");
    }
